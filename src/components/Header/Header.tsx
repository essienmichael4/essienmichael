...
function Desktop(){
    return <header className='hidden fixed w-full h-[6rem] bg-[#0c0c0c57] backdrop-blur-sm md:block'>
...
function Mobile(){
    ...
    return (
        <>
            <header className='block bg-[#0c0c0c57] h-[4rem] backdrop-blur-sm md:hidden'>
            ...
            <nav className={`${isOpen ? "fixed inset-0 flex": "hidden"} bg-[#0c0c0c57] backdrop-blur-sm items-center justify-center gap-8`}>
